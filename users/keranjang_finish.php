...
if(isset($_SESSION['s_emailCust'])){	
	...
	echo "<div>";
	$idPemesanan = @$_SESSION['s_bajuOrder'];
	...
	echo "</table>";
	echo "<p>&nbsp;</p>";
	echo "<table class='table-list' width='75%'>";
	...
	echo "<ol>
		...
		<li>Setelah melakukan pembayaran, segera lakukan konfirmasi <a style='cursor:pointer;color:blue;' onclick=\"javascript: sendRequest('users/konfirmasi.php','id=$idPemesanan','content','div','');\">di sini</a></li>
